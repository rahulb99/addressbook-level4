...
public class StorageManager implements Storage {
    ...
    @Override
    public Optional<ReadOnlyExpenseList> readAddressBook() throws DataConversionException, IOException {
        return readAddressBook(addressBookStorage.getAddressBookFilePath());
    }

    @Override
    public Optional<ReadOnlyExpenseList> readAddressBook(Path filePath) throws DataConversionException, IOException {
