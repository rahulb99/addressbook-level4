...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyExpenseList> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyExpenseList> initialDataSupplier, Path saveFileLocation) {
        super();
    ...
    public EPiggy readStorageAddressBook() {
        try {
            return new EPiggy(storage.readAddressBook().get());
