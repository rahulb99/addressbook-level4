...
public class EditCommandSystemTest extends AddressBookSystemTest {
    ...
    public void edit() {
        ...
        Expense editedExpense = new PersonBuilder(BOB).withTags(VALID_TAG_HUSBAND).build();
        ...
        model.setExpense(getModel().getFilteredPersonList().get(INDEX_FIRST_PERSON.getZeroBased()), editedExpense);
        assertCommandSuccess(command, model, expectedResultMessage);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedExpense = new PersonBuilder(BOB).withName(VALID_NAME_AMY).build();
        assertCommandSuccess(command, index, editedExpense);
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND;
        editedExpense = new PersonBuilder(BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).build();
        assertCommandSuccess(command, index, editedExpense);

        /* Case: clear tags -> cleared */
        index = INDEX_FIRST_PERSON;
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + " " + PREFIX_TAG.getPrefix();
        Expense expenseToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedExpense = new PersonBuilder(expenseToEdit).withTags().build();
        assertCommandSuccess(command, index, editedExpense);
        ...
        expenseToEdit = getModel().getFilteredPersonList().get(index.getZeroBased());
        editedExpense = new PersonBuilder(expenseToEdit).withName(VALID_NAME_BOB).build();
        assertCommandSuccess(command, index, editedExpense);
    ...
    private void assertCommandSuccess(String command, Index toEdit, Expense editedExpense,
        ...
        expectedModel.setExpense(expectedModel.getFilteredPersonList().get(toEdit.getZeroBased()), editedExpense);
        expectedModel.updateFilteredExpenseList(PREDICATE_SHOW_ALL_PERSONS);
